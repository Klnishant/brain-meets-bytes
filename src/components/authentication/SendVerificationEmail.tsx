...
const SendVerificationEmail: React.FC<SignInCardProps> =({onClose,handleSignup,handleIsLoggedIn,handleForgetPassword})=> {
       ...
       <div className="flex flex-col gap-4">
        ...
        <p className="mt-4 text-center text-sm text-[#000000]">
          ...
          <span className="cursor-pointer text-[#D62828] font-medium">
            <button onClick={handleSignup}>Resend</button>
          </span>
        </p>
       </div>
      </div>
